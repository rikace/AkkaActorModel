...
type public AkkaFractalForm() as form = 
    ...
    member form.eventForm_Loading (sender : obj, e : EventArgs) = 
        ...
        let system = ActorSystem.Create("fractal", config)
...
//        let tileRendererRef = spawn system "actor-name" (actorOf2 tileRenderer)
