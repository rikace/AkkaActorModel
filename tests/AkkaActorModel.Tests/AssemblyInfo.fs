...
[<assembly: AssemblyTitleAttribute("AkkaActorModel.Tests")>]
[<assembly: AssemblyProductAttribute("AkkaActorModel")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "AkkaActorModel.Tests"
    let [<Literal>] AssemblyProduct = "AkkaActorModel"
